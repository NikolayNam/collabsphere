...
var (
	...
	ErrOrganizationLegalDocumentAnalysisIDEmpty              = errors.New("organization legal document analysis id is empty")
	ErrOrganizationLegalDocumentAnalysisStatusInvalid        = errors.New("organization legal document analysis status is invalid")
	ErrOrganizationLegalDocumentAnalysisProviderInvalid      = errors.New("organization legal document analysis provider is invalid")
	ErrOrganizationLegalDocumentAnalysisExtractedTextInvalid = errors.New("organization legal document analysis extracted text is invalid")
	ErrOrganizationLegalDocumentAnalysisSummaryInvalid       = errors.New("organization legal document analysis summary is invalid")
	ErrOrganizationLegalDocumentAnalysisFieldsInvalid        = errors.New("organization legal document analysis fields are invalid")
	ErrOrganizationLegalDocumentAnalysisDetectedTypeInvalid  = errors.New("organization legal document analysis detected type is invalid")
	ErrOrganizationLegalDocumentAnalysisConfidenceInvalid    = errors.New("organization legal document analysis confidence is invalid")
	ErrOrganizationLegalDocumentAnalysisLastErrorInvalid     = errors.New("organization legal document analysis last error is invalid")
)
