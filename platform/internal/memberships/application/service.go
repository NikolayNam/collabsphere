...
func (s *Service) AddMember(ctx context.Context, orgID orgDomain.OrganizationID, accountID string, role string) error {
    return s.addMember.Handle(ctx, orgID, accountID, role)
}
